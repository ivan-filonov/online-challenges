...
public class Validate {
    ...
    public void run() {
        ...
        for (int test = 0; test < tests; test++) {
            ...
            int c = inf.nextInt();
            inf.nextLine();
            ensureLimits(a, 0, MAX_NUMBER, String.format("Wrong A[%d] -", test + 1));
            ensureLimits(b, 0, MAX_NUMBER, String.format("Wrong B[%d] -", test + 1));
            ensureLimits(c, 0, MAX_NUMBER, String.format("Wrong C[%d] -", test + 1));
        }
        inf.close();
    }
