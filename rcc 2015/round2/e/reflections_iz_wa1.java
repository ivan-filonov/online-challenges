...
public class reflections_iz_wa1 implements Runnable {
    ...
    class Point {
        ...
        public Point gcd(Point b) {
            ...
            if (x == 0) {
                ...
                int g = reflections_iz_wa1.gcd(y, b.y);
                int o = y / g;
                return new Point(0, y / o);
            }
            int g = reflections_iz_wa1.gcd(x, b.x);
            int o = x / g;
    ...
    public static void main(String[] arg) {
        new Thread(null, new reflections_iz_wa1(), "", 1 << 26).start();
    }
}
